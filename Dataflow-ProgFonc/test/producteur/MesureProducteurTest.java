...
class MesureProducteurTest {
    ...
    @Test
    void testProduireMesures_WithEmptyCapteurList() {
        MesureProducteur producteurVide = new MesureProducteur(Arrays.asList());

        // Si la liste des capteurs est vide, la méthode devrait retourner une liste vide
        List<Mesure> mesures = producteurVide.produireMesures(5);
        assertTrue(mesures.isEmpty(), "La liste des mesures devrait être vide si la liste des capteurs est vide.");
    }
